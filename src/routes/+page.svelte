...
<section>
	<h2>¡Bienvenida comunidad Lolista!</h2>
</section>

<main>
	<p >
		Aquí encontrarás todo tipo de información relacionada con el área deportiva de la institución:
		torneos, intercolegiados, horarios, novedades, entre otros.
	</p>
</main>
